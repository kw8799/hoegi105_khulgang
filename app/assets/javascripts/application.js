...
(function (factory) {
    ...
    Rating.prototype = {
        ...
        listenClick: function ($el, callback) {
            ...
            //$el.on('click touchstart', function (e) {
              $el.on('click touchmove', function(e){
                e.stopPropagation();
                e.preventDefault();
                if (e.handled !== true) {
                    callback(e);
    ...
    $.fn.rating.defaults = {
        ...
        showCaption: true,
        starCaptionClasses: {
            0.0: 'label label-none',
            0.5: 'label label-star',
            1: 'label label-star',
            1.5: 'label label-star',
            2: 'label label-star',
            2.5: 'label label-star',
            3: 'label label-star',
            3.5: 'label label-star',
            4: 'label label-star',
            4.5: 'label label-star',
            5: 'label label-star'
        },
